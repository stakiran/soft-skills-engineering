...
## ネーミング・テクニック
ここからは SSE において重宝する Technique（一部 Thought も含みます）を雑多に紹介します。
...
## b
名前に正直意味はない、ラベルでしかない、定着したら勝ち
 定着はセンスと文脈によって決まる
  センスとは万人か、少なくとも想定読者には広く通用する「出来の良さ」
  文脈は、たとえば私「sta（すた）」と一緒に働いているなら、「スタの法則」という名前でも覚えやすいだろうという話
 名前はただの識別子。その先の概念を見る。
  また必要なら付け直してもいい（リネーミング）、もちろん複数人で使う場合は最終的に統一する
名前はキャッチーに
 つくった概念を選んでもらうため、あるいは思い出してもらうには、キャッチーな名前があるといい
 わかりやすくてシンプルだから良いとは限らない。多少不正確で、雑であっても、キャッチーな方が扱いやすかったりする
  トレメント（Training Element）
  階段のたとえ
 どっちが扱いやすいだろうか。日常生活でよく見る「階段」でたとえた名前の方が、キャッチーで目を引くはず
名前は制約
 先に「良さそうな名前」をつけるのは鉄板。その後、その名前に当てはまるような構成要素を集めて整理する。
略語と有限性
 たとえば QWINCS については、コミュニケーションツールが本当に 6 種類しかないと言っているわけではない。MECE ではない。主なものを 6 つピックアップしているだけだ。クインクスという綺麗な読み方を見つけて、かつこれ以上は見つける自信がなかったので、そこで打ち切っただけである。
 SSE の初心者が陥るアンチパターンに「MECE へのこだわり」と「論理的な整理へのこだわり」がある。前者 MECE は「漏れもなく重複もなく」を示す考え方であり、後者は全体像が論理的に構造化されている（たとえば論文で示せる等）ことを示す。開発者に限らず、ビジネスマンはこのようなこだわりを持ちがちだが、SSE ではアンチパターンだ。SSE では「使えそうな概念」を並べるだけである。無論、MECE や論理構造があるに越したことはないが、主目的ではない。そんなものは実運用して知見を貯めてから行えばいい。
 コミュニケーションツールを n 種類並べた概念をつくりたいとした場合、あなたの意思で n 種類並べればいいのである。アンチパターンに多少頼るのは良いが、逃げてはいけない。あなたが決めることなのだ。たとえばあなたがチャットが大嫌いで、撲滅させたいと思っていて、ウィキと Issues と Notes のヘビーユーザーであるなら、WIN という名前になるかもしれない。あるいは Issues というマニアックな言い方が気に入らないなら Ticket とした上で WTN にしてもいい。この名前だと発音しづらくて、母音を一つ入れたいと思ったら、頭をひねればいい。たとえばインスタントメッセンジャーを思い出し、今もチャットや SNS でダイレクトメッセージの概念は使われている。これを Instant messanger ということで I で表現しよう。これで WITN になる。より読みやすさを出したいなら WINT の方が良い――と、こんな具合で良いのだ。大事なのはあなたがどう捉え、どう整理したかなのである。本書では創造的という言葉を多用してきたが、まさに創造なのだ。ソフトスキル・エンジニアはクリエイターである。クリエイターなら自己表現しなくてはならない。
 もし自分を出すのが苦手か、できないなら、それはソフトスキルが不足している。私はこのようなソフトスキルを「自己表現」と呼んでおり、コミュニケーションやマネジメントといった大カテゴリに位置すると考える。
