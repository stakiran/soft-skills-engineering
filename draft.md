...
生成AIに具体例を挙げさせる
第一言語を定める
 🐰の場合は英語。カッコいいし、ソフトウェアエンジニアとして英単語に触れてきて慣れてるし、ビジネスマンやライフハッカーや自己啓発者として横文字にも慣れているし、具体的な意味を持つ単語が多いのでつくりやすい。
 一方で横文字を嫌う者も少なくないように思う。
 正解はないが、SSE は実用的な概念をつくるものだし、ソフトウェアエンジニアリングにも強い影響を受けているし、このジャンルは英語圏の方が圧倒的に発達しているので、英語を使うようにして英語脳で名前をつくれた方が良いとは考える。が、日本語脳の SSE 実践者をまだ知らないのでわからない。
クリエイティブ・シンキング。発散収束蒸留。蒸留として名前が出てくる。出てくるまで発散と収束を繰り返す。
未来の自分という他人。起源はわからないが、たしかプログラマ界隈の言葉だったと思う。未来の自分、たとえば一週間後の自分は他人のようなものであり、一週間前に書いた自分のコードがまるで他人が書いたコードのように意味不明に見えるという現象を表現した言葉だったかと思う。この考え方は非常に重要だ。まして SSE では動くコードではなく「人間が動かす概念」をつくっているので、未来の自分でも読めなくてはいけない。ということは、未来の自分でも読める程度に丁寧に書かないといけない。ここで「生成 AI に解説させればいい」と思われるかもしれないが、自らつくった概念には自らの文脈が多分に含まれている。生成 AI ではそこまでカバーできず、おそらく一般論を列挙されるだけで終わるだろう。可読性という言葉がある。技術的負債という言葉がある。開発者の中にはこれらが苦手な人が多いイメージがあるが、SSE では向き合わねばならない。 / そして、どういう名前や書き方をすれば未来の自分でも読めるか、を知るにはそれなりの時間を要する。経験を積まねばならない。何事も経験だ。ちなみに、これは完全にライティングの話なので、単に日記やブログといった営みを続けるだけでも鍛えられる。振り返りを行えるとなお良い。振り返りをするということは、書いたテキストを読み返すということだからだ。振り返りについても苦手だったり、続かなかったりする人が多い印象だが、その主因は単にライティング能力不足――未来の自分でもわかるように書くだけの力が不足していることにある。鍛えるしかない。……だけどネーミングの話からちょっと膨らんでるねー🐰
