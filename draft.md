...
本当は開発→提出→運用の各々を深堀りするべき
あるいはABCDウォークのABCD各々を深堀りするべき
- Breakdown: 現状を理解する
- Definition: 問題を定義する
- Collection: 概念を収集する
- Action: 行動を実践する
が、これすると10万文字どころか30万文字でも足らないよなー。。。かといって既存の理論を集めてこれ読めでは意味がない。「エンジニアリング組織論への招待」みたいに端的な解説を交えてリードしてあげてもいいけど、べつになぁ
このSSE本の目的で、SSEというまだ人類が至れてない視座に至らせることにある。既存概念の焼き増しではない。焼き増しならできるやつはいくらでもいるし、権威を持たない俺がやったところで大して意味はない。
